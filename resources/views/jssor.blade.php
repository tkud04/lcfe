    ...
    <script src="lib/jssor/js/jssor.slider-27.5.0.min.js" type="text/javascript"></script>
    <script type="text/javascript">
        jssor_slider_init = function(id) {
		...
		jssor_about_slider_init = function(id) {
		...
		jssor_gallery_slider_init = function(id) {
