<section class="quotes py-5 text-center wow fadeInUp">
		...
		<div class="row wow fadeInUp">
			...
			<div class="col-lg-6 mb-10">
				<h3 class="heading mb-lg-5 mb-4">Certification Agencies</h3>
				<p>Thus is some text to describe the certification agencies on display to the right. The text should be easy to understand and fill up this space.</p><br>
				<p>Thus is some text to describe the certification agencies on display to the right. The text should be easy to understand and fill up this space.</p><br>
				<p>Thus is some text to describe the certification agencies on display to the right. The text should be easy to understand and fill up this space.</p><br>
			</div>
			<!-- //Counter -->
			...
			<div class=" col-lg-6">
				<div id="certification-slider" style="position:relative;margin:0 auto;top:0px;left:0px;width:600px;height:500px;overflow:hidden;visibility:hidden;">
        <!-- Loading Screen -->
    ...
    <script type="text/javascript">jssor_slider_init("certification-slider");</script>
