...
<section class="contact py-5">
	<div class="container wow fadeInUp">
		<h2 class="heading mb-lg-5 mb-4">Register your farmers here, it's super EASY</h2>
		<div class="row contact-grids w3-agile-grid">
			<div id="register-online" class="col-md-12 contact-grid1 w3-agile-grid">
			  <div class="row">
			  <div class="col-md-6">
			    <a id="register-download-btnn" href='download/account.pdf' target="_blank">Click to download registration form</a><br>
				<p>Download the form, fill with your farmers details and submit to our head quarters. Please see below for address.</p>
			  </div>
			  <div class="col-md-6">
			    <button id="register-pay-btn" class="btn btn-primary btn-lg">Register online</button><br>
				<p>Fill in your details and register farmers online..</p>
			  </div>
			  </div>
			</div>
			<div id="register-online-1" class="col-md-12 contact-grid1 w3-agile-grid">
				...
				<form id="farmer-register-form" action="{{url('register-farmer')}}" method="post">
				    {!! csrf_field() !!}
				    <div class="row">
                      <div class="col-md-6">
                   ...
                   <!-- <div class="row">
					...
					<button id="farmer-card" type="submit" class="nbtn text-capitalize start">Submit</button>
				</form>
			</div>
		</div>
