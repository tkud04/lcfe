<section class="quotes py-5 text-center wow fadeInUp">
		...
		<div class="row">
			<!-- Traders -->
			<div class=" col-lg-6">
				<div id="traders-slider" style="position:relative;margin:0 auto;top:0px;left:0px;width:600px;height:500px;overflow:hidden;visibility:hidden;">
        <!-- Loading Screen -->
    ...
    <script type="text/javascript">jssor_slider_init("traders-slider");</script>
    <!-- #endregion Jssor Slider End -->
			</div>
			<!-- Counter -->
			<div class="col-lg-6 mb-10">
				<h3 class="heading mb-lg-5 mb-4">Registered Brokers</h3>
				<p>Thus is some text to describe the registered brokers/traders on display. The text should be easy to understand and fill up this space.</p><br>
				<p>Thus is some text to describe the registered brokers on display. The text should be easy to understand and fill up this space.</p><br>
				<p>Thus is some text to describe the registered brokers on display. The text should be easy to understand and fill up this space.</p><br>
			</div>
			<!-- //Counter -->
